...
public class NhanVien implements Comparable<NhanVien>{
    ...
    private double luongthang,thuong,phucap,tamung,songaycong,luong,tong;
    ...
    public int compareTo(NhanVien o) {
        if (luongthang + phucap != o.luongthang + o.phucap) return (int) (o.luongthang + o.phucap - luongthang - phucap); // sắp xếp là lấy lương tháng + phụ cấp.
